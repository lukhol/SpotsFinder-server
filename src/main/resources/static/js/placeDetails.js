...
//	constructor() {
//		super();
//		let place = generateMockPlace();
//		//this.state = { currentPlace: place };
//		this.props.currentPlace = place;
//	}
	...
	render() {
		...
		for (let j = 0; j < this.props.currentPlace.images.length; j++) {
			imagesHTML.push(<div className={classNameForImagesRow}><img className="img-responsive sf-top-margin thumbnail" src={imagesList[j]} /></div>);
		}
